...
export function MetaIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill="#FFF" d="M16.671 15.542l.532-3.469h-3.328V9.823c0-.949.465-1.874 1.956-1.874h1.514V5.001s-1.374-.235-2.686-.235c-2.741 0-4.533 1.662-4.533 4.669v2.64H7.078v3.469h3.047v8.385a12.09 12.09 0 0 0 3.75 0v-8.385h2.796z" />
    </svg>
  );
}
