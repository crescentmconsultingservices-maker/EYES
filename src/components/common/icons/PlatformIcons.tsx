...
export function MetaIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#0081FB" xmlns="http://www.w3.org/2000/svg">
      <path d="M16.924 3.001c-1.54 0-3.05.626-4.924 2.476C10.126 3.627 8.616 3.001 7.076 3.001 3.167 3.001 0 6.168 0 10.077c0 4.673 3.974 8.784 9.176 10.841 1.05.416 1.77.416 2.824 0 5.202-2.057 9.176-6.168 9.176-10.841 0-3.909-3.167-7.076-7.076-7.076zm-9.848 11.89c-2.317 0-4.202-1.885-4.202-4.202 0-2.317 1.885-4.202 4.202-4.202 1.065 0 2.083.411 3.23 1.493-2.022 2.502-2.826 4.962-3.23 6.911zm9.848 0c-.404-1.949-1.208-4.409-3.23-6.911 1.147-1.082 2.165-1.493 3.23-1.493 2.317 0 4.202 1.885 4.202 4.202 0 2.317-1.885 4.202-4.202 4.202z"/>
    </svg>
  );
}
...
export function WhatsAppIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path fill="#25D366" d="M12.012 2c-5.506 0-9.969 4.463-9.969 9.969 0 1.763.458 3.483 1.327 5.002L2 22l5.176-1.358c1.474.804 3.136 1.227 4.836 1.227 5.506 0 9.969-4.463 9.969-9.969C21.981 6.463 17.518 2 12.012 2zm0 18.281c-1.487 0-2.943-.4-4.218-1.157l-.302-.18-3.133.82.835-3.057-.197-.313a8.31 8.31 0 0 1-1.272-4.425c0-4.595 3.738-8.333 8.333-8.333 4.595 0 8.333 3.738 8.333 8.333 0 4.595-3.738 8.333-8.333 8.333zm4.565-6.236c-.25-.125-1.474-.727-1.703-.81-.229-.083-.396-.125-.562.125-.167.25-.646.81-.792.977-.146.167-.292.188-.542.063s-1.057-.389-2.014-1.242c-.744-.664-1.247-1.484-1.393-1.734-.146-.25-.015-.385.11-.509.112-.112.25-.292.375-.438.125-.146.167-.25.25-.417.083-.167.042-.313-.021-.438s-.562-1.354-.771-1.854c-.203-.487-.41-.421-.562-.428l-.479-.009c-.167 0-.438.063-.667.313s-.875.854-.875 2.083.896 2.417 1.021 2.583c.125.167 1.762 2.69 4.269 3.773.596.258 1.061.412 1.424.527.599.19 1.144.163 1.575.099.481-.071 1.474-.604 1.683-1.188.208-.583.208-1.083.146-1.188-.063-.105-.229-.167-.479-.292z"/>
    </svg>
  );
}
