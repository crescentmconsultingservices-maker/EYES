...
export function InstagramIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#E4405F" xmlns="http://www.w3.org/2000/svg">
