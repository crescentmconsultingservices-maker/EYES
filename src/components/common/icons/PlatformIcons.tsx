...
export function MetaIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
      <path fill="#1877F2" d="M256 128C256 57.308 198.692 0 128 0S0 57.308 0 128c0 63.883 46.884 116.815 108 126.347v-89.378H75.625V128H108V99.5c0-31.97 19.043-49.625 48.175-49.625 13.953 0 28.55.25 28.55.25v31.375h-16.085c-15.85 0-20.79 9.837-20.79 19.95V128h35.35l-5.65 36.969h-29.7V254.35C209.116 244.815 256 191.883 256 128z"/>
      <path fill="#FFFFFF" d="M174.55 164.969l5.65-36.969h-35.35V99.5c0-10.113 4.94-19.95 20.79-19.95h16.085V48.175s-14.597-.25-28.55-.25c-29.132 0-48.175 17.655-48.175 49.625V128H108v36.969h32v89.378c6.435 1.01 13.045 1.653 19.78 1.653 6.945 0 13.765-.67 20.4-1.742v-89.289h25.969z"/>
    </svg>
  );
}

export function WhatsAppIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 258" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
      <path fill="#25D366" d="M214.6 41.2C191.8 18.3 161.4 5.7 129.2 5.7 63.6 5.7 10.2 59.1 10.2 124.7c0 20.9 5.5 41.4 15.9 59.4L10 248.3l65.8-17.2c17.3 9.4 36.8 14.4 53.4 14.4h.1c65.6 0 119-53.4 119-119 0-31.8-12.4-61.7-33.7-85.3z"/>
      <path fill="#FFF" d="M129.3 225.2h-.1c-17.7 0-35-4.8-50.1-13.8l-3.6-2.1-37.2 9.7 9.9-36.3-2.3-3.7C36 163.6 30.6 144.5 30.6 124.7c0-54.4 44.3-98.7 98.7-98.7 26.4 0 51.2 10.3 69.8 28.9s28.9 43.4 28.9 69.8c.1 54.4-44.2 98.7-98.7 98.7z"/>
      <path fill="#25D366" d="M98.6 75.9c-2.4-5.4-4.9-5.5-7.2-5.6-1.9-.1-4.1-.1-6.3-.1s-5.8.8-8.8 4.1c-3 3.3-11.5 11.2-11.5 27.4s11.8 31.8 13.4 34 22.8 36.1 56.4 49.3c22.3 8.7 30.9 9.5 41.8 7.9 6.6-1 21.3-8.7 24.3-17.1s3-15.6 2.1-17.1c-.9-1.5-3.3-2.4-6.9-4.2s-21.3-10.5-24.6-11.7c-3.3-1.2-5.7-1.8-8.1 1.8s-9.3 11.7-11.4 14.1c-2.1 2.4-4.2 2.7-7.8.9-3.6-1.8-15.2-5.6-29-17.9-10.7-9.6-18-21.4-20.1-25-2.1-3.6-.2-5.6 1.6-7.3 1.6-1.6 3.6-4.2 5.4-6.3 1.8-2.1 2.4-3.6 3.6-6 1.2-2.4.6-4.5-.3-6.3s-7.1-17.5-9.9-24.3z"/>
    </svg>
  );
}

export function InstagramIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
      <defs>
        <radialGradient id="ig-grad" cx="0.3" cy="1.05" r="1.15">
      ...
      <path fill="none" stroke="#FFFFFF" strokeWidth="20" d="M128 65c-34.8 0-63 28.2-63 63s28.2 63 63 63 63-28.2 63-63-28.2-63-63-63zm0 104c-22.6 0-41-18.4-41-41s18.4-41 41-41 41 18.4 41 41-18.4 41-41 41z"/>
      <circle cx="184" cy="72" r="12" fill="#FFFFFF"/>
      <rect x="40" y="40" width="176" height="176" rx="46" fill="none" stroke="#FFFFFF" strokeWidth="20"/>
    </svg>
  );
}
