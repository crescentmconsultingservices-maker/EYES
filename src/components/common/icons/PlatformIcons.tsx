...
export function MetaIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#0081FB" xmlns="http://www.w3.org/2000/svg">
      <path d="M16.42 2C13.88 2 11.83 3.66 10.66 5.86C9.48 3.66 7.43 2 4.89 2C2.19 2 0 4.19 0 6.89C0 11.82 8.42 18.9 10.66 20.73C12.9 18.9 21.32 11.82 21.32 6.89C21.32 4.19 19.12 2 16.42 2Z"/>
    </svg>
  );
}
...
export function WhatsAppIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path fill="#25D366" d="M19.05 4.91A9.816 9.816 0 0 0 12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01zm-7.01 15.24c-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.19 8.19 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24 2.2 0 4.27.86 5.82 2.42a8.18 8.18 0 0 1 2.41 5.83c.01 4.54-3.69 8.23-8.22 8.23z"/>
    </svg>
  );
}
