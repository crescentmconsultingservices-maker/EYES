...
export const ALL_POSSIBLE_PLATFORMS = [
  ...
  { id: 'instagram',       name: 'Instagram Professional', icon: <InstagramIconOfficial />, category: 'Social', description: 'Official Meta integration. Sync creator/business DMs and posts.', color: '#E4405F' },
